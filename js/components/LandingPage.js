                    ...
                    <section className="max-w-7xl mx-auto px-4 py-16">
                        <div className="text-center mb-20">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                                <button onClick={() => onNavigate('resident-request')} className="bg-green-500 hover:bg-green-600 text-white px-10 py-5 rounded-full text-xl font-semibold shadow-lg hover:shadow-xl transition transform hover:-translate-y-1">
                                    I Need Help
                                </button>
                                <button onClick={() => onNavigate('volunteer-signup')} className="bg-orange-500 hover:bg-orange-600 text-white px-10 py-5 rounded-full text-xl font-semibold shadow-lg hover:shadow-xl transition transform hover:-translate-y-1">
                                    I Want to Volunteer
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-3xl p-12 text-center">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <button onClick={() => onNavigate('volunteer-signup')} className="bg-white text-blue-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-gray-100 transition">
                                    Become a Volunteer
                                </button>
                                <button onClick={() => onNavigate('resident-request')} className="bg-white text-blue-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-gray-100 transition">
                                    Request Help
                                </button>
                            </div>
                        </div>
