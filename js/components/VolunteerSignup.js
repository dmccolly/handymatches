// VolunteerSignup Component
        function VolunteerSignup({ onNavigate, users, setUsers }) {
            ...
            const skills = [
                { category: 'Home Repairs', items: ['Plumbing', 'Electrical Work', 'Painting', 'Carpentry'] },
                { category: 'Pet Care', items: ['Dog Walking', 'Pet Sitting'] },
                { category: 'Outdoor', items: ['Gardening', 'Lawn Mowing'] }
            ];
                        ...
                        {step === 1 && (
                            <div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <input type="text" placeholder="ZIP Code" className="w-full px-4 py-3 border rounded-lg" 
